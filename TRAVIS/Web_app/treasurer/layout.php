...
function sidebar(string $active = ''): void {
    ...
    echo '<div class="sidebar-brand"><img class="municipal-seal" src="' . esc(asset_url('assets/images/nasugbu-seal.jpg')) . '" alt="Municipality of Nasugbu seal"><div class="municipal-brand-copy"><div class="brand-logo-wordmark">NASUGBU · TMO</div><small>Treasury & Collection Portal</small></div></div>';

...
<body>
  <main class="landing">
    <div class="container">
      <nav>
        <a class="brand" href="index.php"><img src="../../assets/images/nasugbu-seal.jpg" alt="Official seal of the Municipality of Nasugbu, Batangas"><span><strong>NASUGBU · TMO</strong><small>Traffic Management Office</small></span></a>
      ...
      <section class="hero">
        <div class="hero-copy reveal">
          ...
          <div class="actions">
            <a class="button button-primary" href="landing.php">Enter Public Portal <i class="bi bi-arrow-right"></i></a>
          </div>
